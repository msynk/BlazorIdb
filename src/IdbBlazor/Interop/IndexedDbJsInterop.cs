...
/// <summary>
/// Thin .NET wrapper around the <c>window.IdbBlazor</c> JavaScript object defined in
...
public sealed class IndexedDbJsInterop
{
        ...
        string dbName, int version, string schemaJson)
    {
        var result = await _js.InvokeAsync<JsonElement>(
            "IdbBlazor.openDatabase", dbName, version, schemaJson);
    ...
    public Task DeleteDatabaseAsync(string dbName)
        => _js.InvokeAsync<bool>("IdbBlazor.deleteDatabase", dbName).AsTask();
    ...
    public Task<string> AddAsync(string dbName, string storeName, string valueJson)
        => _js.InvokeAsync<string>("IdbBlazor.add", dbName, storeName, valueJson).AsTask();
    ...
    public Task<string> PutAsync(string dbName, string storeName, string valueJson)
        => _js.InvokeAsync<string>("IdbBlazor.put", dbName, storeName, valueJson).AsTask();
    ...
    public Task<string?> GetAsync(string dbName, string storeName, string keyJson)
        => _js.InvokeAsync<string?>("IdbBlazor.get", dbName, storeName, keyJson).AsTask();

    /// <summary>Deletes a record by primary key.</summary>
    public Task DeleteAsync(string dbName, string storeName, string keyJson)
        => _js.InvokeAsync<bool>("IdbBlazor.delete", dbName, storeName, keyJson).AsTask();
    ...
    public Task<string> GetAllAsync(string dbName, string storeName, IdbKeyRange? range = null)
    {
        ...
        return _js.InvokeAsync<string>("IdbBlazor.getAll", dbName, storeName, rangeJson).AsTask();
    }
        ...
        string dbName, string storeName, string indexName, IdbKeyRange range)
    {
        ...
        return _js.InvokeAsync<string>("IdbBlazor.getAllByIndex",
    ...
    {
        var rangeJson = range != null ? JsonSerializer.Serialize(range, _json) : null;
        return _js.InvokeAsync<string>("IdbBlazor.getAllKeys", dbName, storeName, rangeJson).AsTask();
    }
    ...
    {
        var rangeJson = JsonSerializer.Serialize(range, _json);
        return _js.InvokeAsync<string>("IdbBlazor.getAllKeysByIndex",
            dbName, storeName, indexName, rangeJson).AsTask();
    }
    ...
    public Task<int> CountAsync(string dbName, string storeName)
        => _js.InvokeAsync<int>("IdbBlazor.count", dbName, storeName).AsTask();
    ...
    {
        var rangeJson = JsonSerializer.Serialize(range, _json);
        return _js.InvokeAsync<int>("IdbBlazor.countByIndex",
            dbName, storeName, indexName, rangeJson).AsTask();
    }

    /// <summary>Removes all records from a store.</summary>
    public Task ClearAsync(string dbName, string storeName)
        => _js.InvokeAsync<bool>("IdbBlazor.clear", dbName, storeName).AsTask();
        ...
        IEnumerable<TransactionOperation> operations)
    {
        ...
        return _js.InvokeAsync<string>("IdbBlazor.executeTransaction",
    ...
    public Task<int> SubscribeToStoreAsync(
        ...
        int intervalMs = 500)
        => _js.InvokeAsync<int>("IdbBlazor.subscribeToStore",
    ...
    public Task UnsubscribeAsync(int subscriptionId)
        => _js.InvokeVoidAsync("IdbBlazor.unsubscribeFromStore", subscriptionId).AsTask();
}

...
(function () {
    ...
    function getDb(dbName) {
        ...
        if (!db) throw new Error(`BlazorIdb: Database '${dbName}' is not open. Call openDatabase first.`);
        return db;
    }
    ...
    const BlazorIdb = {
        ...
        openDatabase: function (dbName, version, schemaJson) {
            return new Promise((resolve, reject) => {
                ...
                request.onblocked = function () {
                    reject(new Error(`BlazorIdb: Database '${dbName}' upgrade is blocked by another open connection.`));
                };
            });
        },
        ...
        executeTransaction: function (dbName, storeNamesJson, mode, operationsJson) {
            return new Promise((resolve, reject) => {
                ...
                tx.onabort = () => reject(new Error('BlazorIdb: Transaction aborted.'));
                ...
                function runOp(i) {
                    ...
                    switch (op.type) {
                        ...
                        default:
                            reject(new Error(`BlazorIdb: Unknown operation type '${op.type}'.`));
                            return;
                    }
                    req.onsuccess = () => {
                ...
                req.onsuccess = function () {
                    ...
                    if (snapshot !== lastSnapshot) {
                        ...
                        dotnetRef.invokeMethodAsync(callbackMethod, snapshot).catch(function (err) {
                            console.warn('BlazorIdb LiveQuery callback error:', err);
                        });
                    }
                };
            };
